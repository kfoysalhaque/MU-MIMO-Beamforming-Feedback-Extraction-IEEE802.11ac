...
if mobility
    ...
    folders_name = ['/home/foysal/Dropbox/Research/MU-MIMO/Activity_Recognition/Data/FeedBack/preli_test_2/split/'];
end
...
for folder_idx = 1:size(folders_name, 1)
    ...
    for file_idx = 1:numel(files)
        ...
        folder_save = strcat('/home/foysal/Dropbox/Research/MU-MIMO/Activity_Recognition/Data/FeedBack/preli_test_2/', folder_proc, '/', user_name, '/');
