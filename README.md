...
#### MU-MIMO BFI from AP to the multiple STAs can be collected in a signle capture which can be leveraged in various applications including *Radio Fingerprinting, Wi-Fi Sensing, Spectrum Sensing*
